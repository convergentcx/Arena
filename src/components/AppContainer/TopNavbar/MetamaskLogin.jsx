                ...
                title={
                  <React.Fragment>
                    <Grid container style={{ textAlign: 'center' }}>
                      <Grid item xs={12}>
                        <Typography variant="subtitle1" style={{ color: '#DDDDDD', fontSize: '12px' }}>
                          {shortenAddress(drizzleState.accounts[0])}
                        </Typography>
                      </Grid>
                      <Grid item xs={12}>
                        <Typography variant="subtitle1" style={{ color: '#DDDDDD', fontSize: '14px' }}>
...
export default withStyles(styles)(MetamaskLogin);
